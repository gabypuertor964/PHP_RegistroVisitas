...
@section('content')
    <form action="{{route("trabajadores.update",$info_trabajador->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="sectionPanel">
            ...
            <div class="col-md-7">
                ...
                <div class="col-md-12 input">
                    ...
                    <input type="text" class="form-control" name="name" value="{{$info_usuario->name}}">
                </div>
                ...
                <div class="col-md-12 input">
                    ...
                    <select class="form-control form-select form-select-lg col-md-12" name="tip_doc" id="tip_doc">
                        ...
                        @foreach ($listado_tipo_documentos as $tipo_documento)
                            ...
                            @if ($tipo_documento==$info_trabajador->tip_doc)
                                <option selected value="{{$tipo_documento}}">{{$tipo_documento}}</option>
                            @else
                ...
                <div class="col-md-12 input">
                    ...
                    <input type="text" class="form-control" name="num_doc" value="{{$info_trabajador->num_doc}}">
                </div>

                <!--Input: fecha de nacimiento trabajador-->
                <div class="col-md-12 input">
                    <label for="fech_nac" class="form-label">Fecha de Nacimiento:</label>
                    <input type="date" class="form-control" name="fech_nac" value="{{$info_trabajador->fech_nac}}">
                </div>
                ...
                <div class="col-md-12 input">
                    ...
                    <select class="form-control form-select form-select-lg col-md-12" name="sexo">
                        ...
                        @foreach ($listado_sexo as $sexo)
                            @if ($sexo==$info_trabajador->sexo)
        ...
        <div class="sectionPanel sectionPanel2">
            ...
            <div class="col-md-6 input">
                ...
                <input type="text" class="form-control" name="num_tel" value="{{$info_trabajador->num_tel}}">
            </div>
        ...
        <div class="sectionPanel sectionPanel2">
            ...
            <div class="col-md-6 input">
                ...
                <input type="email" class="form-control" name="email" value="{{$info_usuario->email}}">
            </div>
