...
@section('title', 'Registro Visita')

@section('content_header')
    <div class="container text-center">
        <h1 style="font-size: 30px;">Registrar Nueva Visita</h1>
    </div>
@stop
...
@section('content')
    <form action="{{route("visitas.store")}}" method="POST" enctype="multipart/form-data">
        ...
        @csrf
        <input type="hidden" name="id_visit" value="{{$info_visitante[0]->id}}">
        ...
        <div class="sectionPanel">
            ...
            <div class="col-md-7">
                ...
                <div class="col-md-12 input">
                    ...
                    <input type="text" class="form-control" name="nombres" value="{{$info_visitante[0]->nombres}}" required>
                </div>

                <!--Input: Apellidos visitante-->
                <div class="col-md-12 input">
                    <label for="apellidos" class="form-label">Apellidos:</label>
                    <input type="text" class="form-control" name="apellidos" value="{{$info_visitante[0]->apellidos}}" required>
                </div>
                ...
                <div class="col-md-12 input">
                    ...
                    <select class="form-control form-select form-select-lg col-md-12" name="tip_doc" id="tip_doc" required>
                        ...
                        @foreach ($listado_tipo_documentos as $tipo_documento)
                            @if ($info_visitante[0]->tip_doc==$tipo_documento)
                ...
                <div class="col-md-12 input">
                    ...
                    <input type="text" class="form-control" name="num_doc" value="{{$info_visitante[0]->num_doc}}" required>
                </div>
            ...
            <div class="card col-md-5 text-center">
                ...
                <div class="card-body">
                    <img src="{{asset($info_visitante[0]->url)}}" class="img-fluid rounded-top col-md-12">  
        ...
        <div class="sectionPanel">
            ...
            <div class="col-md-6 input">
                ...
                <input type="text" class="form-control" name="num_tel" value="{{$info_visitante[0]->num_tel}}" required>
            </div>

            <!--Input: Correo Electronico visitante-->
            <div class="col-md-6 input">
                <label for="correo" class="form-label">Correo Electronico (Opcional):</label>
                <input type="correo" class="form-control" name="correo" value="{{$info_visitante[0]->correo}}">
            </div>
        </div>
        ...
        <div class="sectionPanel">
            ...
            <div class="col-md-6 input">
                ...
                <select class="form-control form-select form-select-lg col-md-12" name="id_equipo" id="lista" required>
        ...
        <div class="sectionPanel">
            ...
            <div class="col-md-6 input">
                ...
                <input type="text" class="form-control" name="cod_gafete" required>
            </div>
        </div>
